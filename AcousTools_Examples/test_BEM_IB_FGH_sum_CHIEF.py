if __name__ == '__main__':
    ...
    for i,d in enumerate(ds):
        ...
        E,F,G,H = compute_E(scatterer, p2,board=board, path=path, use_cache_H=False, p_ref=p_ref,H_method='OLS', return_components=True, internal_points=internal_points)
...
ax2 = ax1.twinx()
ax2.plot(diams,pressures, color='red')
