...
x =translate_hologram(x, dz=-0.005, board=board)
...
diameters = torch.linspace(0.0001, wavelength, N)
# diameters = torch.linspace(0.01, 0.03, N)
...
for i in range(N):
    ...
    # norms = getx_normals_as_points(sphere)
