if __name__ == '__main__':
    ...
    from acoustools.Mesh import load_multiple_scatterers,scale_to_diameter, centre_scatterer, get_edge_data, get_CHIEF_points, get_centre_of_mass_as_points, translate
    ...
    p2 = create_points(1,1,0,0,-0.022)
    ...
    for i,d in enumerate(ds):
        ...
        # internal_points  = get_CHIEF_points(scatterer, P = 50, start='centre', method='uniform')
        internal_points = get_CHIEF_points(scatterer, P = 50, start='centre', method='uniform', scale = 0.1, scale_mode='diameter-scale')
        ...
        # Visualise(*ABC(0.02),x, res=(200,200), colour_functions=[propagate_BEM_pressure], colour_function_args=[{'scatterer':scatterer,'path':path,'board':board,'p_ref':p_ref}])
