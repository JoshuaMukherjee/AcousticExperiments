if __name__ == '__main__':
    ...
    from acoustools.Mesh import load_multiple_scatterers,scale_to_diameter, centre_scatterer, get_edge_data, get_verticies_as_points
    ...
    E = compute_E(scatterer, p,board=board, path=path, use_cache_H=False, BM_c=alpha)
    ...
    Visualise(*ABC(0.03), x, points=p,colour_functions=[propagate_BEM_pressure], res=(200,200),
              colour_function_args=[{'scatterer':scatterer,'board':board,'path':path,"use_cache_H":False,"BM_c":alpha }])
