...
print(trap_up)
print(propagate_BEM_pressure(x,trap_up,reflector,TOP_BOARD,path=path,H=H))
print(BEM_gorkov_analytical(x,trap_up,reflector,TOP_BOARD,path=path,H=H))

Visualise(A,B,C, x, colour_functions=[propagate_BEM_pressure],colour_function_args=[{"scatterer":reflector,"board":TOP_BOARD,"path":path,'H':H}],vmax=5000, show=True,res=[256,256],points=trap_up)