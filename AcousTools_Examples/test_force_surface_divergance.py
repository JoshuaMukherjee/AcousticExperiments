...
from acoustools.BEM import BEM_compute_force, compute_E, propagate_BEM_pressure, force_mesh_surface_divergance
...
for i in range(N):
    ...
    div = force_mesh_surface_divergance(x, sphere,board, H=H, path=path, surface=surface)
    print(d, div)


   
    divs.append(div.cpu().detach())
