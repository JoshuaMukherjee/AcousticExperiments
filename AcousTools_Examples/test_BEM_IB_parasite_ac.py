if __name__ == '__main__':
    ...
    from acoustools.Mesh import load_scatterer,scale_to_diameter, centre_scatterer, get_edge_data, merge_scatterers, translate, insert_parasite, get_centre_of_mass_as_points
    ...
    a = get_centre_of_mass_as_points(scatterer) + create_points(1,1,0,0,wavelength/4 + 0.002)
    ...
    parasite_scatterer = insert_parasite(scatterer)
    ...
    Visualise(*ABC(0.03), x, points=a,colour_functions=[propagate_BEM_pressure, propagate_BEM_pressure], res=(600,600),
              colour_function_args=[{'scatterer':parasite_scatterer,'board':board,'path':path,"use_cache_H":False,"p_ref":p_ref,'a':a,'c':1 },
